...
const TotalBankSettlement = () => {
  const [totalSales, setTotalSales] = useState(0);
  const [filterValue, setFilterValue] = useState(1); // Default to Daily

  useEffect(() => {
    const apiUrl = `${API_BASE_URL}/api/dashboard/TotalBankSettelment`;
  ...
  return (
    <div >
      <div className="bg-gray-200 p-4 rounded-md shadow-md">
        <h2 className="text-xl font-bold mb-4">Total Bank settlement</h2>
...
export default TotalBankSettlement;